...
var _user$project$ToolTip$formatY = function (info) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'$',
		_elm_lang$core$Basics$toString(info.income));
};
var _user$project$ToolTip$formatX = function (info) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'Age: ',
		_elm_lang$core$Basics$toString(info.age));
};
var _user$project$ToolTip$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$ToolTip$init = {
	hovered: {ctor: '[]'}
};
var _user$project$ToolTip$Model = function (a) {
	return {hovered: a};
};
var _user$project$ToolTip$Info = F4(
	function (a, b, c, d) {
		return {age: a, weight: b, height: c, income: d};
	});
var _user$project$ToolTip$alice = {
	ctor: '::',
	_0: A4(_user$project$ToolTip$Info, 10, 34, 1.34, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$ToolTip$Info, 15, 42, 1.62, 3000),
		_1: {
			ctor: '::',
			_0: A4(_user$project$ToolTip$Info, 25, 75, 1.73, 55000),
			_1: {
				ctor: '::',
				_0: A4(_user$project$ToolTip$Info, 35, 75, 1.73, 75000),
				_1: {
					ctor: '::',
					_0: A4(_user$project$ToolTip$Info, 45, 83, 1.75, 115000),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$ToolTip$bobby = {
	ctor: '::',
	_0: A4(_user$project$ToolTip$Info, 10, 38, 1.32, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$ToolTip$Info, 15, 69, 1.75, 2000),
		_1: {
			ctor: '::',
			_0: A4(_user$project$ToolTip$Info, 25, 75, 1.87, 32000),
			_1: {
				ctor: '::',
				_0: A4(_user$project$ToolTip$Info, 35, 75, 1.87, 48000),
				_1: {
					ctor: '::',
					_0: A4(_user$project$ToolTip$Info, 45, 77, 1.87, 62000),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$ToolTip$chuck = {
	ctor: '::',
	_0: A4(_user$project$ToolTip$Info, 10, 42, 1.35, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$ToolTip$Info, 15, 72, 1.72, 1800),
		_1: {
			ctor: '::',
			_0: A4(_user$project$ToolTip$Info, 25, 89, 1.83, 65000),
			_1: {
				ctor: '::',
				_0: A4(_user$project$ToolTip$Info, 35, 75, 1.87, 78000),
				_1: {
					ctor: '::',
					_0: A4(_user$project$ToolTip$Info, 45, 95, 1.84, 98000),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$ToolTip$Hover = function (a) {
	return {ctor: 'Hover', _0: a};
};
var _user$project$ToolTip$chart = function (model) {
	return A2(
		_terezka$line_charts$LineChart$viewCustom,
		{
			...
			container: A2(
				_terezka$line_charts$LineChart_Container$styled,
				'line-chart',
				{
					ctor: '::',
			...
			interpolation: _terezka$line_charts$LineChart_Interpolation$default,
			intersection: _terezka$line_charts$LineChart_Axis_Intersection$default,
			legends: _terezka$line_charts$LineChart_Legends$byEnding(
				_terezka$line_charts$LineChart_Junk$label(_terezka$line_charts$LineChart_Colors$black)),
			events: _terezka$line_charts$LineChart_Events$hoverMany(_user$project$ToolTip$Hover),
			junk: A3(_terezka$line_charts$LineChart_Junk$hoverMany, model.hovered, _user$project$ToolTip$formatX, _user$project$ToolTip$formatY),
			grid: _terezka$line_charts$LineChart_Grid$default,
			area: _terezka$line_charts$LineChart_Area$default,
			line: _terezka$line_charts$LineChart_Line$default,
			dots: _terezka$line_charts$LineChart_Dots$hoverMany(model.hovered)
		},
		{
			ctor: '::',
			_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$purple, _terezka$line_charts$LineChart_Dots$diamond, 'Alice', _user$project$ToolTip$alice),
			_1: {
				ctor: '::',
				_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$cyan, _terezka$line_charts$LineChart_Dots$circle, 'Bobby', _user$project$ToolTip$bobby),
				_1: {
					ctor: '::',
					_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$pink, _terezka$line_charts$LineChart_Dots$triangle, 'Chuck', _user$project$ToolTip$chuck),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$ToolTip$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$ToolTip$chart(model),
			_1: {ctor: '[]'}
		});
};
var _user$project$ToolTip$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$ToolTip$init, update: _user$project$ToolTip$update, view: _user$project$ToolTip$view})();

var Elm = {};
Elm['ToolTip'] = Elm['ToolTip'] || {};
if (typeof _user$project$ToolTip$main !== 'undefined') {
    _user$project$ToolTip$main(Elm['ToolTip'], 'ToolTip', undefined);
}
