		...
		return A2(
			_terezka$line_charts$LineChart$viewCustom,
			{
				...
				x: _terezka$line_charts$LineChart_Axis$custom(
					{
						title: _terezka$line_charts$LineChart_Axis_Title$default('x'),
				...
				container: _terezka$line_charts$LineChart_Container$custom(
					{
						...
						margin: A4(_terezka$line_charts$LineChart_Container$Margin, 30, 100, 60, 50),
						id: 'chart-id'
					}),
			...
			{
				ctor: '::',
				_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$pink, _terezka$line_charts$LineChart_Dots$circle, 'Alice', data.alice),
				_1: {
					ctor: '::',
					_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$cyan, _terezka$line_charts$LineChart_Dots$circle, 'Bobby', data.bobby),
					_1: {
						ctor: '::',
						_0: A4(_terezka$line_charts$LineChart$line, _terezka$line_charts$LineChart_Colors$blue, _terezka$line_charts$LineChart_Dots$circle, 'Chuck', data.chuck),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Selection$xAxisRangeConfig = function (selection) {
	...
	return A2(_terezka$line_charts$LineChart_Axis_Range$window, start, end);
};
	...
	function (system, selection) {
		...
		if (_p4.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A6(
					_terezka$line_charts$LineChart_Junk$rectangle,
					system,
					{
						ctor: '::',
	...
	function (model, selection) {
		return A2(
			...
			model.data,
			{
				...
				events: _terezka$line_charts$LineChart_Events$hoverOne(_user$project$Selection$Hint),
			...
			events: _terezka$line_charts$LineChart_Events$custom(
				{
					...
					_0: A4(
						...
						'mousedown',
						A3(_terezka$line_charts$LineChart_Events$Options, true, true, false),
					...
					_1: {
						...
						_1: {
							...
							_0: A4(
								_terezka$line_charts$LineChart_Events$onWithOptions,
								'mouseup',
								A3(_terezka$line_charts$LineChart_Events$Options, true, true, true),
...
var Elm = {};
Elm['Selection'] = Elm['Selection'] || {};
if (typeof _user$project$Selection$main !== 'undefined') {
    _user$project$Selection$main(Elm['Selection'], 'Selection', undefined);
}
